...
pub const BINDINGS: &[Binding] = &[
    ...
    Binding { keys: "<space>c", what: "pick a file git says you have changed", mode: "normal" },
    ...
    Binding { keys: ":g/pat/cmd", what: "run a command on every matching line (:g/dbg!/d)", mode: "command" },
    Binding { keys: ":v/pat/cmd", what: "and :g!: on every line that does not match", mode: "command" },
    Binding { keys: ":d :3,7d :%d", what: "delete lines, into the register p puts back", mode: "command" },
