...
While it runs, the dog in the status line runs with it, and barks when a clean
build comes back — see [The dog](#the-dog). Waiting wants something to look at,
and there was already an animal in there with nothing to do.
